...
### Released
- Released **platform-foundation-blueprint** publicly as a reviewable operating system for identity governance.
...
### Shipped
- Cut the first coherent internal version of **platform-foundation-blueprint** with stable domain objects, review surfaces, and decision outputs.
